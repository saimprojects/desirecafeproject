...
<section id="hero" className="min-h-screen bg-gradient-to-br from-[#fef8f0] via-[#fff5e6] to-[#fff0e0] relative overflow-hidden">
    ...
    <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
      ...
      <div className={`space-y-6 sm:space-y-8 transition-all duration-700 delay-100 ${visibleSections.hero ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
        ...
        <div className="space-y-4">
          <p className="text-amber-800 font-semibold text-base sm:text-lg italic">
            Dear Ladies and Gentlemen,
          </p>
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            It gives me great pleasure to welcome you to <span className="font-bold text-amber-800">Desire's Specialty Catering</span>.
          </p>
        </div>
        ...
        <div className="space-y-3">
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            Desire's Specialty Catering, based in <span className="font-semibold">Abu Dhabi</span>, is your perfect professional catering & events partner in the UAE capital.
          </p>
          
          {/* Bullet Points */}
          <div className="space-y-3 mt-4">
            <div className="flex items-start gap-3 group">
              <div className="w-6 h-6 bg-amber-100 rounded-full flex items-center justify-center mt-0.5 group-hover:bg-amber-200 transition">
                <span className="text-amber-800 text-xs font-bold">✓</span>
              </div>
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                <span className="font-semibold">Top Quality</span> in the ingredients used
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                <span className="font-semibold">Craftsmanship</span> in the preparation
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                <span className="font-semibold">Personal Service</span> with attention to detail
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                <span className="font-semibold">Perfect Organizational</span> processes
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Customer Focus */}
        <div className="bg-amber-50/50 rounded-2xl p-5 border-l-4 border-amber-600 mt-4">
          <p className="text-amber-900 font-semibold text-lg mb-2">
            For Our Customers:
          </p>
          <p className="text-gray-700 text-base leading-relaxed">
            Desire's Specialty Catering focuses on <span className="font-bold text-amber-800">YOU and your wishes!</span>
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            We have the appropriate <span className="font-semibold">know-how</span> to realize your ideas perfectly.
          </p>
        </div>
        ...
        <div className="space-y-2">
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
            I hope you enjoy discovering our <span className="font-bold text-amber-800">First-class products</span>, which we prepare for you with love and creativity.
          </p>
        </div>
  ...
  <div className={`relative max-w-4xl mx-auto text-center px-4 sm:px-6 transition-all duration-700 ${visibleSections.cta ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}>
    ...
    <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
      ...
      {/* Working Call Button - Direct Phone Call */}
      <a 
        href="tel:+971502625729" 
